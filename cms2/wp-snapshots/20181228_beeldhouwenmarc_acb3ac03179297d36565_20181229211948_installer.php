...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20181228_beeldhouwenmarc_acb3ac03179297d36565_20181229211948_archive.zip';
	const ARCHIVE_SIZE		 = '22308858';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'acb3ac0-29211948';
	const VERSION			 = '1.3.0';
